				...
				<table class="table table-bordered table-hover" id="complaint-tbl">
			        ...
			        <tbody>
			          ...
			          <tr class="<?php echo $row['status'] == 1 ? 'border-alert' : '' ?>">
						...
						<td class="text-center">
			            	<a href="index.php?page=response&id=<?php echo $row['id'] ?>" ><button class="btn btn-primary btn-sm m-0 view_btn" type="button" >Response</button></a	>
			            </td>
			          </tr>
			        <?php endwhile; ?>
			        </tbody>
