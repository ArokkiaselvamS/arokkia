...
$q3="select *from complaints_action where complaint_id='$complainant'";
...
Spot Image:<img src="images/<?php echo $image?> " width="500px"><br><br>
</div>
<br><br><br><br>
...
Accuest Image:<img src="images/<?php echo $aimage?> " width="500px">
